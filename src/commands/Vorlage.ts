    ...
    async execute(interaction: Interaction) {
        ...
        switch(id) {
            case "sahp_application":
                ...
                break;
            case "swat_application":
                var embed = new EmbedBuilder()
                    .setFooter({
                        text: "Athena-System | made with ❤️ by Spades",
                        iconURL: interaction.client.user?.avatarURL()!!
                    })
                    .setTitle('Vorlage - SWAT | Bewerbung')
                    .setDescription('Bitte füge die einzelnen Puntke in deinen Bewerbungstext ein.')
                    .setColor("Blue")
                    .addFields([
                        {
                        ...
                        {
                            name: "**Wieso möchte ich in das Special Weapon and Tactics-Team?**",
                            value: "Schildere hier wieso du in das Special Weapon and Tactics-Team eintreten willst."
                        },
                        {
                            name: "**Welche Erfahrungen bringst du mit?**",
                            value: "Nenne hier welche Erfahrungen du mitbringst."
